<!-- =====  CONTAINER START  ===== -->
<?php $category_id = $this->uri->segment(2); 
$category_detail = $this->lib->get_row_array('categories',array('id'=>$category_id)); 
?>
  ...
  <div class="row ">
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 mtb_30"> 
      ...
      <div class="breadcrumb ptb_20">
        <h1 class="main-title" style="color:#000;"><?php echo $category_detail->category_name; ?></h1>
        <ul >
          <li><a href="<?php echo base_url(); ?>">Home</a></li>
          <li><a href="<?php echo base_url(); ?>">Category</a></li>
          <li style="color:#e80184;" class="active"><?php echo $category_detail->category_name; ?></li>
        </ul>
      </div>
      <!-- =====  BREADCRUMB END===== -->
   <!--   <div class="category-page-wrapper mb_30">
      ...
      <div class="row">
      	<?php $products = $this->lib->get_by_id('products','product_categories',$category_id);      
          if($products){
    	            ...
    	            <div class="product-thumb clearfix mb_30">
    	              <div class="image product-imageblock"> 
    	              	<a href="<?php echo base_url('product-detail/').$pro->id; ?>"> 
    	              		...
    	              		<?php }else{?>
                          <img src="http://placehold.it/300x384?text=Image+Not+Found" alt="<?php echo strtoupper($pro->product_name); ?>" title="<?php echo strtoupper($pro->product_name); ?>" class="img-responsive" /> 
                        <?php } } ?>
    	              	</a> 
    	              </div>
